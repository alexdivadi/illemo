...
final entriesServiceProvider = AutoDisposeProvider<EntriesService>.internal(
  ...
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$entriesServiceHash,
  dependencies: null,
...
String _$entriesTileModelStreamHash() => r'e8f3184f1b1db43eb92198669492a36d3ee03356';
...
final entriesTileModelStreamProvider =
  ...
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$entriesTileModelStreamHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef EntriesTileModelStreamRef = AutoDisposeStreamProviderRef<List<EntriesListTileModel>>;
